...
static_assert(EasyDataWrite::cSize == sizeof(EasyDataWrite), "Invalid size of struct EasyDataRead" );
static_assert( 0 == offsetof(EasyDataWrite, VarEngineSpeedEntry), "Invalid offset of EasyDataRead::VarEngineSpeedEntry" );
static_assert( 2 == offsetof(EasyDataWrite, VarEngineStateSwitch), "Invalid offset of EasyDataRead::VarEngineStateSwitch" );
static_assert( 3 == offsetof(EasyDataWrite, SigFlashLigth), "Invalid offset of EasyDataRead::SigFlashLight" );
static_assert( 4 == offsetof(EasyDataWrite, SigHeadLight), "Invalid offset of EasyDataRead::SigHeadLight" );
