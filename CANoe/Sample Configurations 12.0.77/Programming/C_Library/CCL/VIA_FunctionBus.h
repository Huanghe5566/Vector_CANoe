...
#define VIAFunctionBusServiceMinorVersion 9
...
enum VIAFbValueClass
{
  ...
  eSubscriptionState, // Subscription state of PDU/Event AP
  eLatestCall,        // Latest call input parameters of function AP
  eLatestReturn,      // Latest call return parameters of function AP
...
// Callback handler to notify observers about event subscription and desubscripition
...
// Callback handler to notify observers about PDU subscription and desubscripition
...
// Callback handler to notify observers about field subscription and desubscripition
...
// Callback handler to notify observers about event group subscription and desubscripition
